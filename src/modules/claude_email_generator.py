...
Uses Anthropic's Claude API to generate follow-up emails from meeting transcripts
"""
...
class ClaudeEmailGenerator:
    ...
    def generate_followup_email(
        ...
        Returns:
            Generated email text in HTML format
        """
...
if __name__ == "__main__":
    ...
    try:
        generator = ClaudeEmailGenerator()
        print("Generating follow-up email with Claude...\n")
